	...
	public void actionPerformed(ActionEvent e) {
		...
		if (state == PLAY) {
			if (new Rectangle(ballposX, ballposY, 20, 20).intersects(
				...
				ballYdir = -ballYdir;
			} else if (new Rectangle(ballposX, ballposY, 20, 20).intersects(new Rectangle(paddle.getPosX() + 70, 550, 30, 8))) {
				ballYdir = -ballYdir;
			} else if (new Rectangle(ballposX, ballposY, 20, 20).intersects(new Rectangle(paddle.getPosX() + 30, 550, 40, 8))) {
				ballYdir = -ballYdir;
			}
